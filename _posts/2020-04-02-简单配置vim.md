...
配置安装步骤详情请看[这里](https://github.com/Duan-JM/dotfiles)呀，使用 auto
install
...
Plug 'vim-scripts/YankRing.vi'                         " multiple yank record
                                                        " <leader>p to trigger
...
:F <search-pattern> **/*  # 搜索当前文件夹内包含 <search-pattern> 的位置，快捷键 <leader>s/
...
2. 运行 debug
    ...
    ```
    **Reference**: [Is there a "vim runtime log"?](https://stackoverflow.com/questions/3025615/is-there-a-vim-runtime-log)
